...
private Connection conn = new koneksi().connect();
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(bkeluar, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addGap(26, 26, 26)
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(45, Short.MAX_VALUE))
        );

        jPanel1.getAccessibleContext().setAccessibleName("DATA BARANG YANG TERSIMPAN");
    ...
    private boolean kdSudahDaftar(String kd_barang) {
        String sql = "SELECT kd_barang FROM barang WHERE kd_barang = ?";
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        ...
        String sql = "UPDATE barang set nama_barang=?,jenis_barang=?,harga_beli=?,harga_jual=? where kd_barang=?" ;
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
