...
public class Master_Pelanggan extends javax.swing.JFrame {
    ...
    protected void datatable() {
        ...
        try {
            String sql = "SELECT * FROM pelanggan WHERE id_pelanggan LIKE '%" + cariitem + "%' "
                    ...
                    + "OR jenis_kelamin_p LIKE '%" + cariitem + "%' "
                    + "OR no_telp_p LIKE '%" + cariitem + "%' "
                    + "OR alamat_pelanggan LIKE '%" + cariitem + "%' "
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        ...
        String sql = "UPDATE pelanggan set nama_pelanggan=?,jenis_kelamin_p=?,no_telp_p=?,alamat_pelanggan=? where id_pelanggan=?" ;
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
    ...
    String idPelanggan = id_pel.getText().trim();
        ...
        if (ok == 0) {
            String sql = "delete from pelanggan where id_pelanggan='" + id_pel.getText() + "'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
